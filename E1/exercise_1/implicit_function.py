...
def signed_distance_sphere(x, y, z, r, x_0, y_0, z_0):
    ...
    # ###############
    # TODO: Implement
    distance_sphere = np.sqrt(np.square(x - x_0) + np.square(y - y_0) + np.square(z - z_0)) - r
...
def signed_distance_torus(x, y, z, R, r, x_0, y_0, z_0):
    ...
    distance_torus = np.sqrt(np.square(a) + np.square(y - y_0)) - r
    return distance_torus
    # ###############
...
def signed_distance_atom(x, y, z):
    ...
    # ###############
    # TODO: Implement
    signed_dis_to_proton = signed_distance_sphere(x, y, z, proton_radius, proton_center[0], proton_center[1], proton_center[2])
    signed_dis_to_electron = signed_distance_sphere(x, y, z, electron_radius, electron_center[0], electron_center[1], electron_center[2])
    signed_dis_to_orbit = signed_distance_torus(x, y, z, orbit_radius, orbit_thickness, proton_center[0], proton_center[1], proton_center[2])
    signed_distance = np.minimum(signed_dis_to_proton, signed_dis_to_orbit)
    signed_distance = np.minimum(signed_dis_to_electron, signed_distance)
